...
-----------------------------------------------------------------------------------
#Questions for Prof MC 3/19 11pm
  #We were getting messed up on the join for fbi_lee to vacpd via county_name... we were thinking of changing gears and instead doing it via agency? Since each ori is a police dept? in each county ?? If Im understanding that correctly 
  #Does our analysis up to this point look accurate/ like the questions we are posing are on the right path?
    # - From Frances. Thanks! 
